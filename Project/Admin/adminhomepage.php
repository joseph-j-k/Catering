              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="../Asset/Templates/Admin/assets/img/profile.jpg"
                        alt="..."
...
// Fetch data from the user table and join with place and district tables
$query = "
    SELECT 
        *
    FROM tbl_user u
...
if(isset($_GET['aid'])) {
    $user_id = $_GET['aid'];
     $query = "UPDATE tbl_user SET user_status = '1' WHERE user_id = $user_id";
    if($con->query($query))
    {
      ?>
            <script>
...
if(isset($_GET['rid'])) {
  $user_id = $_GET['rid'];
   $query = "UPDATE tbl_user SET user_status = '2' WHERE user_id = $user_id";
  if($con->query($query))
    {
      ?>
            <script>
                ...
                <table id="user-table" class="display table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            // echo "<td><a href='../Asset/Files/user/Photo/{$row['user_photo']}'><img src='../Asset/Files/user/photo/{$row['user_photo']}' alt='User Photo' width='50'></a></td>";
