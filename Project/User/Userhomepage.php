        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6">
                   <a href="http://localhost/Catering/Project/User/viewpackagebody.php?pid=74" class="single_service">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single_order">
                        <div class="order_thumb">
                            <img src="../Asset/Templates/Main/img/order/order-2.png" alt="">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single_order">
                        <div class="order_thumb">
                            <img src="../Asset/Templates/Main/img/order/order-3.png" alt="">
                ...
                <!-- <div class="col-xl-4 col-md-6">
                    <div class="single_order">
                        <div class="order_thumb">
                            <img src="../Asset/Templates/Main/img/order/order-4.png" alt="">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single_order">
                        <div class="order_thumb">
                            <img src="../Asset/Templates/Main/img/order/order-5.png" alt="">
                            <div class="order_prise">
                                <span>10.00</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single_order">
                        <div class="order_thumb">
                            <img src="../Asset/Templates/Main/img/order/order-6.png" alt="">
                            <div class="order_prise">
                                <span>10.00</span>
                            </div>
                        </div>
...
if ($con) {
    ...
    $feedbackQuery = "
        ...
        FROM tbl_feedback f
        JOIN tbl_user u ON f.user_id = u.user_id"; // Adjust the join based on your actual table structure
             ...
             ?>
                        <div class="single_testmonial d-flex">
                            <div class="testmonial_thumb">
                                <?php 
                                // Specify the path to the user photo
                                // $photoPath = './Asset/Files/Photo/' . htmlspecialchars($row['user_photo']);
                                // Debugging output to check the constructed photo path
                                // echo '<p>Trying to load photo from: ' . $photoPath . '</p>';
                                ?>
                            ...
                            <div class="testmonial_author">
                                ...
                                <p><?php echo htmlspecialchars($row['feedback_content']); ?></p>
                            </div>
                        </div>
                    <?php 
                }
